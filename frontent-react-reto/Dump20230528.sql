...
--
-- Host: localhost    Database: db_pruebatecnica
-- ------------------------------------------------------
...
CREATE TABLE `alumno` (
  ...
  `creditos_inscritos` int DEFAULT NULL,
...
INSERT INTO `alumno` VALUES (1,17,'Medicina','Pedro','Villa'),(2,15,'Derecho','Juan ','Alvarez'),(3,16,'Medicina','Daniel','Velez'),(4,17,'Derecho','Francisco','Santos');
...
CREATE TABLE `curso` (
  ...
  `nombre_prerequisito` varchar(255) DEFAULT NULL,
...
CREATE TABLE `profesor` (
  ...
  `firs_name` varchar(255) DEFAULT NULL,
  `last_name` varchar(255) DEFAULT NULL,
  `maximo_titulo` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2023-05-28 23:57:33
